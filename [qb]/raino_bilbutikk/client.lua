...
local vehHeaderMenu = {
    {
        ...
        params = {
            event = 'raino_bilbutikk:client:showVehOptions'
        }
    }
}
...
local financeMenu = {
    {
        ...
        params = {
            event = 'raino_bilbutikk:client:getVehicles'
        }
    }
}
...
local returnTestDrive = {
    {
        ...
        params = {
            event = 'raino_bilbutikk:client:TestDriveReturn'
        }
    }
}
        ...
        while inTestDrive do
            if GetGameTimer() < gameTimer + tonumber(1000 * testDriveTime) then
                ...
                if secondsLeft >= tonumber(1000 * testDriveTime) - 20 or GetPedInVehicleSeat(NetToVeh(testDriveVeh), -1) ~= PlayerPedId() then
                    TriggerServerEvent('raino_bilbutikk:server:deleteVehicle', testDriveVeh)
                    testDriveVeh = 0
                    inTestDrive = false
                ...
                while insideShop do
                    ...
                    vehicleMenu = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'raino_bilbutikk:client:TestDrive',
                            }
                        },
                        {
                            ...
                            params = {
                                isServer = true,
                                event = 'raino_bilbutikk:server:buyShowroomVehicle',
                                args = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'raino_bilbutikk:client:openFinance',
                                args = {
                                    price = getVehPrice(),
                                    buyVehicle = Config.Shops[insideShop]["ShowroomVehicles"][ClosestVehicle].chosenVehicle
                                }
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'raino_bilbutikk:client:vehCategories',
                            }
                        },
                    }
                    Wait(1000)
                ...
                while insideShop and PlayerData.job and PlayerData.job.name == Config.Shops[name]['Job'] do
                    ...
                    vehicleMenu = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'raino_bilbutikk:client:openIdMenu',
                                args = {
                        ...
                        },
                        {
                            ...
                            icon = "fa-solid fa-coins",
                            params = {
                                event = 'raino_bilbutikk:client:openCustomFinance',
                                args = {
                                    price = getVehPrice(),
                                    vehicle = Config.Shops[insideShop]["ShowroomVehicles"][ClosestVehicle].chosenVehicle
                                }
...
RegisterNetEvent('raino_bilbutikk:client:customTestDrive', function(data)
...
RegisterNetEvent('raino_bilbutikk:client:TestDriveReturn', function()
...
RegisterNetEvent('raino_bilbutikk:client:vehCategories', function()
	local catmenu = {}
    local categoryMenu = {
        {
            ...
            params = {
                event = 'raino_bilbutikk:client:homeMenu'
            }
        }
    }
    ...
    for k, v in pairs(catmenu) do
        categoryMenu[#categoryMenu + 1] = {
            ...
            params = {
                event = 'raino_bilbutikk:client:openVehCats',
                args = {
                    catName = k
                }
            }
                ...
                for _, shop in pairs(QBCore.Shared.Vehicles[k]["shop"]) do
                    if shop == insideShop then
                        vehMenu[#vehMenu + 1] = {
                            ...
                            params = {
                                isServer = true,
                                event = 'raino_bilbutikk:server:swapVehicle',
                                args = {
                                    toVehicle = v.model,
...
RegisterNetEvent('raino_bilbutikk:client:openFinance', function(data)
    ...
    if dialog then
        ...
        TriggerServerEvent('raino_bilbutikk:server:financeVehicle', dialog.downPayment, dialog.paymentAmount, data.buyVehicle)
    end
end)
...
RegisterNetEvent('raino_bilbutikk:client:openCustomFinance', function(data)
    ...
    if dialog then
        ...
        TriggerServerEvent('raino_bilbutikk:server:sellfinanceVehicle', dialog.downPayment, dialog.paymentAmount, data.vehicle, dialog.playerid)
    end
end)
        ...
        for _, v in pairs(vehicles) do
            if v.balance ~= 0 then
                ...
                ownedVehicles[#ownedVehicles + 1] = {
                    ...
                    icon = "fa-solid fa-car-side",
                    params = {
                        event = 'raino_bilbutikk:client:getVehicleFinance',
                        args = {
                            vehiclePlate = plate,
                            balance = v.balance,
...
RegisterNetEvent('raino_bilbutikk:client:getVehicleFinance', function(data)
    local vehFinance = {
        {
            header = Lang:t('menus.goback_header'),
            params = {
        ...
        },
        {
            ...
            icon = "fa-solid fa-hand-holding-dollar",
            params = {
                event = 'raino_bilbutikk:client:financePayment',
                args = {
                    vehData = data,
        ...
        },
        {
            ...
            params = {
                isServer = true,
                event = 'raino_bilbutikk:server:financePaymentFull',
                args = {
...
RegisterNetEvent('raino_bilbutikk:client:financePayment', function(data)
    ...
    if dialog then
        ...
        TriggerServerEvent('raino_bilbutikk:server:financePayment', dialog.paymentAmount, data.vehData)
    end
end)
...
RegisterNetEvent('raino_bilbutikk:client:openIdMenu', function(data)
    ...
    if dialog then
        ...
        if data.type == 'testDrive' then
            TriggerServerEvent('raino_bilbutikk:server:customTestDrive', data.vehicle, dialog.playerid)
        elseif data.type == 'sellVehicle' then
            TriggerServerEvent('raino_bilbutikk:server:sellShowroomVehicle', data.vehicle, dialog.playerid)
        end
    end
end)
