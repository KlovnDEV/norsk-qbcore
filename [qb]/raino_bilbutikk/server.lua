...
RegisterNetEvent('raino_bilbutikk:server:addPlayer', function(citizenid)
...
RegisterNetEvent('raino_bilbutikk:server:deleteVehicle', function (netId)
    local vehicle = NetworkGetEntityFromNetworkId(netId)
    DeleteEntity(vehicle)
end)

-- Sync vehicle for other players
RegisterNetEvent('raino_bilbutikk:server:swapVehicle', function(data)
    local src = source
    TriggerClientEvent('raino_bilbutikk:client:swapVehicle', -1, data)
    Wait(1500)-- let new car spawn
    TriggerClientEvent('raino_bilbutikk:client:homeMenu', src)-- reopen main menu
end)
...
RegisterNetEvent('raino_bilbutikk:server:financeVehicle', function(downPayment, paymentAmount, vehicle)
    local src = source
