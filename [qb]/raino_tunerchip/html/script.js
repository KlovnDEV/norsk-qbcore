...
$(document).on('click', '#save', function(){
    $.post('https://raino_tunerchip/save', JSON.stringify({
...
$(document).on('click', '#reset', function(){
    $.post('https://raino_tunerchip/reset');
});
...
$(document).on('click', "#save-neon", function(){
    if (RainbowNeon) {
        $.post('https://raino_tunerchip/saveNeon', JSON.stringify({
...
$(document).on('click', '#save-headlights', function(){
    $.post('https://raino_tunerchip/saveHeadlights', JSON.stringify({
        value: headlightVal,
...
$(document).on('click', '#save-stancer', function(){
    ...
    $.post('https://raino_tunerchip/SetStancer', JSON.stringify({
...
QBTuner.Open = function() {
    $.post('https://raino_tunerchip/checkItem', JSON.stringify({item: "tunerlaptop"}), function(hasItem){
        if (hasItem) {
...
QBTuner.Close = function() {
    ...
    $.post('https://raino_tunerchip/exit');
}